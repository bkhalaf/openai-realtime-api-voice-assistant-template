...
// Constants
const SYSTEM_MESSAGE = `You are an AI receptionist for Ameer Eyes Clinic.
...
fastify.register(async (fastify) => {
    fastify.get("/media-stream", { websocket: true }, (connection, req) => {
        ...
        // Resolve the correct WebSocket reference depending on @fastify/websocket version
                    ...
                    messages: [
                        {
                            role: "system",
                            content:
                                "Extract appointment details from the transcript: customer name, reason for visit, and preferred date/time.",
                        },
        ...
        if (
            ...
            try {
                ...
                if (parsedContent) {
                    ...
                    console.log(
                        "Extracted and sent appointment details:",
                        parsedContent,
                    );
                } else {
                    console.error(
